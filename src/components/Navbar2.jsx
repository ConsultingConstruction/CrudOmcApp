    ...
    <div id="body-pd">
      <header className="header" id="header">
        <div className="header_toggle" id='iconClose'>
          ...
          <img className="imgLogo" src="https://consulting.construction/wp-content/uploads/elementor/thumbs/Consulting-Construction_Soluciones-integrales-para-la-industria-AEC_logoW-po2z60znnm1ypcpd6tsb9443x322o3bd1tlfnfbtb0.png" alt="" />
      ...
      <div className="l-navbar" id="nav-bar">
        <nav className="nav">
          ...
          <div>
           {estadoUser === 'bx bx-menu'?(<NavLink to="/#" className="nav_logo">
                <SiSuperuser className="bx bx-layer nav_logo-icon"/>
              <span className="nav_logo-name">PERFIL</span>
            </NavLink>):(<div className="nav_logo containerAvatarImg" id="avatarLogin">
                <img className="avatarImg" src='https://thumbs.dreamstime.com/b/icono-de-hombre-negocios-imagen-avatar-macho-vector-perfil-con-gafas-y-peinado-barba-179728610.jpg'></img>
            </div>)}
            ...
            <div className="nav_list">
              ...
              <div className="nav_link" onClick={()=>showListMaterials()}>
                ...
                <span className="nav_name buttonSubList">COMPLEMENTAR NORMA <i className="fa-solid fa-angle-right" style={{color:'#fff'}}/><i className="fa-solid fa-angle-right" style={{color:'#fff'}}/></span>
              </div>
              {/* Lista desplegable */}
              ...
              <div className="nav_link"  onClick={()=>showListProviders()}>
                ...
                <span className="nav_name  buttonSubList">PROVEEDORES <i className="fa-solid fa-angle-right" style={{color:'#fff'}}/><i className="fa-solid fa-angle-right" style={{color:'#fff'}}/></span>
              </div>
